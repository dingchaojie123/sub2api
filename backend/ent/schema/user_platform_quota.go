	...
	return []ent.Field{
		...
		field.String("platform").
			...
			Validate(func(s string) error {
				...
				switch s {
				case "anthropic", "openai", "gemini", "antigravity", "grok", "jimeng", "doubao", "qwen", "kimi", "deepseek", "midjourney", "kling", "happyhourse", "seedance", "bytedance", "wan3", "minimax-h3", "minimax-h3-compshare", "minimax-speech", "qwen-tts", "pixverse-v6", "grok-imagine-video", "kuaishou":
					return nil
				default:
