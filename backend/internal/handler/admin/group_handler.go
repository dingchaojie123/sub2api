...
type CreateGroupRequest struct {
	...
	Platform         string             `json:"platform" binding:"omitempty,oneof=anthropic openai gemini antigravity grok jimeng doubao qwen kimi deepseek kling happyhourse seedance bytedance wan3 minimax-h3 pixverse-v6"`
