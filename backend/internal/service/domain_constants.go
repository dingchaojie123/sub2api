...
const (
	...
	SettingKeyInvitationCodeEnabled            = "invitation_code_enabled"             // 是否显示注册页可选邀请码
	...
	SettingKeyModelPricingPageData        = "model_pricing_page_data"       // 模型列表页面展示数据（JSON 数组）
	...
	// for probing remote Corgi API-key billing metadata.
