export default {
  ...
  onboarding: {
    ...
    user: {
      welcome: {
        title: '👋 Welcome to Corgi',
        description: '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">Hello! Welcome to the Corgi AI service platform.</p><p style="margin-bottom: 12px;"><b>🎯 Quick Start:</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>🔑 Create API Key</li><li>📋 Copy key to your application</li><li>🚀 Start using AI services</li></ul><p style="color: #10b981; font-weight: 600;">Just 1 minute, let\'s get started →</p></div>',
        nextBtn: 'Start 🚀',
        prevBtn: 'Skip'
      },
      keyManage: {
  ...
  payment: {
    ...
    balanceUnit: 'balance',
    realChargeHint: 'Consumption still follows the paid amount',
    lotteryChances: '{count} lucky-card blind-box chance(s)',
    noLotteryChances: 'No blind-box chance',
    ...
    invalidProduct: 'Please select a valid top-up product',
