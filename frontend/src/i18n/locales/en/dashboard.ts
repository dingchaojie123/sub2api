export default {
  ...
  keys: {
    ...
    useKeyModal: {
      ...
      grok: {
        description: 'Configure Grok Build, Claude Code, Codex, or OpenCode to send requests through your Corgi Grok group.',
        claudeDescription: 'Configure Claude Code to send Messages API traffic through your Corgi Grok group.',
        codexDescription: 'Configure Codex to send Responses API traffic through your Corgi Grok group.',
